...
def test_print_ref__link__nested_types(api_mock):
    nested_type_with_id = TypeRef(language="lang")
    nested_type_with_id.name = "Nested1"
    nested_type_with_id.id = "lang-nested1"

    nested_type_without_id = TypeRef(language="lang")
...
def test_print_ref__link__closure(api_mock):
    arg1_type = TypeRef(language="lang")
    ...
    arg2_type = TypeRef(language="lang")
    ...
    return_type = TypeRef(language="lang")
...
def test_print_ref__link__complex_closure(api_mock):
    ...
    ref.nested = [TypeRef(language="lang")]

    ref.nested[0].returns = TypeRef(language="lang")
    ref.nested[0].returns.name = "void"
    ref.nested[0].args = [Parameter()]

    ref.nested[0].args[0].type = TypeRef(language="lang")
    ref.nested[0].args[0].type.name = "std::shared_ptr"
    ref.nested[0].args[0].type.prefix = "const "
    ref.nested[0].args[0].type.suffix = "&"
    ref.nested[0].args[0].type.nested = [TypeRef(language="lang")]
...
def test_print_ref__link__closure_with_nested_types__custom_start_and_end(api_mock):
    nested_type = TypeRef(language="lang")
    nested_type.name = "Nested1"

    arg_type = TypeRef(language="lang")
...
def test_argument_list(generating_api):
    type1 = TypeRef(language="lang", prefix="const ", name="Type1")
    type2 = TypeRef(language="lang", name="Type2", suffix=" &", id="lang-type2")
    type3 = TypeRef(language="lang", name="Type3", nested=[type1, type2])
...
def test_argument_list__skip_tparam(generating_api):
    type1 = TypeRef(language="lang", prefix="typename ", name="Type1")
    type2 = TypeRef(language="lang", name="Type2", suffix=" &", id="lang-type2")
    type3 = TypeRef(language="lang", name="Type3", nested=[type1, type2])
...
def test_method_signature__single_param(generating_api):
    method = Compound(language="lang")
    method.name = "ShortMethod"
    method.returns = ReturnValue(type=TypeRef(language="lang", name="void"))
    method.params = [
        Parameter(
            kind="param",
            name="value",
            type=TypeRef(language="lang", name="int"),
        )
    ]
...
def test_method_signature__multiple_params(generating_api):
    ...
    method.params = [
        ...
        Parameter(
            name="other_value",
            kind="param",
            type=TypeRef(language="lang", name="double"),
        ),
        Parameter(
            name="text",
            kind="param",
            type=TypeRef(language="lang", name="std::string"),
        )
    ]
...
def test_method_signature__multiple_params__last_param_too_wide(generating_api):
    method = Compound(
        language="lang",
        name="ShortMethod",
        returns=ReturnValue(type=TypeRef(language="lang", name="void")),
        params=[
            Parameter(
                name="value",
                kind="param",
...
def test_method_signature__ignore_return_type_xref_length(generating_api):
    method = Compound(
        language="lang",
        name="ShortMethod",
        returns=ReturnValue(type=TypeRef(language="lang", name="void", id="ab" * 80)),
        params=[Parameter(name="value", type=TypeRef(language="lang", name="int"), kind="param")],
    )
    ...
    method = Compound(
        ...
        params=[
            Parameter(kind="param",
                      name="value",
                      type=TypeRef(language="lang", name="int", id="ab" * 80))
        ],
    )
...
def test_method_signature__template_params(generating_api):
    method = Compound(
        language="lang",
        name="ShortMethod",
        returns=ReturnValue(type=TypeRef(language="lang", name="V")),
        params=[
            Parameter(
                kind="tparam",
                type=TypeRef(language="lang", name="K", prefix="typename "),
            ),
            Parameter(
                kind="tparam",
                type=TypeRef(language="lang", name="V", prefix="class "),
            ),
            Parameter(
                name="key",
                kind="param",
                type=TypeRef(language="lang", name="K"),
            ),
            Parameter(
                name="default",
                kind="param",
                type=TypeRef(language="lang", name="V"),
            )
        ],
    )
