    ...
    [
        param(dict(name="asciidoxy.Coordinate", kind="class", lang="kotlin"),
              m_compound(
                  ...
                  members=Unordered(
                      m_compound(name="isValid", kind="function"),
                      m_compound(name="latitude", kind="property"),
                      m_compound(name="longitude", kind="property"),
                      m_compound(name="altitude", kind="property"),
                      m_compound(name="Coordinate", kind="constructor"),
                      m_compound(name="Companion", kind="object"),
                  ),
              ),
              id="Basic class"),
        param(
