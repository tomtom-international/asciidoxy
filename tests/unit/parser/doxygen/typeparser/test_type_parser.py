...
def test_type_parser__type_from_tokens(prefixes, names, nested_types, arg_types, suffixes,
    ...
    for expected_type in arg_types.expected_types:
        if expected_type.refid:
            ...
            unresolved_type_names.append(expected_type.name)
    reference_mock.assert_unresolved(*unresolved_type_names)
    reference_mock.assert_unchecked(*unchecked_type_ids)
...
def test_type_parser__parse_xml__unresolved_ref_with_driver():
    ...
    reference_mock.add_unchecked_reference.assert_not_called()
...
def test_type_parser__parse_xml__register_ref_with_id_as_unchecked():
    ...
    reference_mock.add_unchecked_reference.assert_called_once_with(type_ref)
