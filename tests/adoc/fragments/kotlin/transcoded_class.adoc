...
|*Public Constructors*
|
`xref:kotlin-classcom_1_1asciidoxy_1_1geometry_1_1_coordinate_1ab88068a456629b5519234b68de8c375f[Coordinate()]`::
Default constructor.

|*Public Methods*
|
`xref:kotlin-classcom_1_1asciidoxy_1_1geometry_1_1_coordinate_1a1430fa173dddd5b12f049044f86e4244[Latitude(): Double]`::
Latitude.
`xref:kotlin-classcom_1_1asciidoxy_1_1geometry_1_1_coordinate_1afe78701035a481e3ee4f5611355a54ed[Longitude(): Double]`::
Longitude.
`xref:kotlin-classcom_1_1asciidoxy_1_1geometry_1_1_coordinate_1a7da297a2e2933bb44990d2e61a22f4cd[Altitude(): Double]`::
Altitude.
`xref:kotlin-classcom_1_1asciidoxy_1_1geometry_1_1_coordinate_1aa2c0aedf89e6586b74745b58e166eba7[IsValid(): Boolean]`::
