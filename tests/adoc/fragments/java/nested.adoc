...
|*Enclosed types*
|
`xref:java-enumcom_1_1asciidoxy_1_1traffic_1_1_traffic_event_1_1_severity[Severity]`::
...
|*Constructors*
|
`xref:java-classcom_1_1asciidoxy_1_1traffic_1_1_traffic_event_1a2b99e6d20827eb9e86c958333acabb3e[TrafficEvent(TrafficEventData)]`::
Construct a traffic event from data.

|*Methods*
|
`xref:java-classcom_1_1asciidoxy_1_1traffic_1_1_traffic_event_1a7a344438ceca76397d7a54bed6cdefac[TrafficEventData Data()]`::
Get the traffic event details.
`xref:java-classcom_1_1asciidoxy_1_1traffic_1_1_traffic_event_1a72847da5fa4e03763f089c5d044085d4[boolean Update(int, int)]`::
...
[source,java,subs="-specialchars,macros+"]
----
boolean Update(int cause, int delay)
----
...
include::DIRECTORY/java-enumcom_1_1asciidoxy_1_1traffic_1_1_traffic_event_1_1_severity.adoc[leveloffset=+1]
