...
|*Properties*
|
`xref:objc-protocol_a_d_traffic_event-p_1a5a6d6782afcd9a6ee29c71499802bc1b[data]`::
Traffic event details.

|*Methods*
|
`xref:objc-protocol_a_d_traffic_event-p_1aaa32145fd9b5ebec01740ac078738262[updateWithCause:andDelay:]`::
