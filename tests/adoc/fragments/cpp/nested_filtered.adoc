...
|*Public Methods*
|
`xref:cpp-classasciidoxy_1_1traffic_1_1_traffic_event_1a8573ce8e432ca9831f9441ec31653c28[const TrafficEventData & Data() const]`::
...
`xref:cpp-classasciidoxy_1_1traffic_1_1_traffic_event_1add924f17b33ae36301cf42f1233951cf[std::shared_ptr&lt;TrafficEventData&gt; SharedData() const]`::
...
`xref:cpp-classasciidoxy_1_1traffic_1_1_traffic_event_1a0c01e73a5c19c5ebaf6a27cf4a6f2da0[void RegisterTrafficCallback(std::function&lt;void(const TrafficEventData &, int delay)&gt;)]`::
Register a callback to receive updates for the traffic event.

|*Private Variables*
|
`xref:cpp-classasciidoxy_1_1traffic_1_1_traffic_event_1a93fd5356b283261ffbaccfccfa7164ad[data_]`::
