...
=== Added
  ...
  * For increased performence in subsequent runs, generated python code for templates is cached in
    the build directory. Use command line argument `--cache-dir` to set a different location for 
    the cache.
