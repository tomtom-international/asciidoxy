...
This example shows documentation for a Java project. The documentation is generated using the
following AsciiDoxy directives:

[source,python]
----
${"""
${api.insert("com.asciidoxy.geometry.Coordinate")}
"""}
----
