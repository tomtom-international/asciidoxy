...
This example shows how documentation for Swift can be generated for a Swift library. The
documentation is generated using the following AsciiDoxy directives:
