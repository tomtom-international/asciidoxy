...
versions are specified in the ${api.cross_document_ref("../reference/requirements.adoc",
...
${api.cross_document_ref("../reference/requirements.adoc", link_text="requirements")}.
