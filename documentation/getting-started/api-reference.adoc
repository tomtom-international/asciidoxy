...
${api.cross_document_ref("../manual/doxygen.adoc",
                         link_text="the doxygen section of the manual")}.
====
...
${api.cross_document_ref("../manual/packages.adoc", link_text="packages section of the manual")}.
====
...
${api.cross_document_ref("../manual/commands.adoc", anchor="api_insert", link_text="api.insert")}.
====
...
====
For more options, see the documentation for
${api.cross_document_ref("../manual/commands.adoc", anchor="api_namespace", link_text="api.namespace")}.
====
...
====
For more options, see the documentation for
${api.cross_document_ref("../manual/commands.adoc", anchor="api_link", link_text="api.link")}.
====
