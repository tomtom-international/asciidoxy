...
This is an example demonstrating documentation for an Objective C project transcoded to Swift. The
used source code files come from the https://github.com/AFNetworking/AFNetworking[AFNetworking]
project.
