...
[ ${api.cross_document_ref("about.adoc", "_what_is_asciidoxy", "What is AsciiDoxy?")} |
${api.cross_document_ref("usage.adoc", "_usage", "Usage")} |
${api.cross_document_ref("examples.adoc", "_examples", "Examples")} |
${api.cross_document_ref("contributing.adoc", "_contributing", "Contributing")} ]
