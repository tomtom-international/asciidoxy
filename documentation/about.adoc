...
optionally a version file. See ${api.cross_document_ref("usage.adoc",
...
the information from the Doxygen XML files. See ${api.cross_document_ref("usage.adoc",
link_text="Usage")} for more details.
