...
optionally a version file. See ${api.cross_document_ref("reference/packages.adoc",
...
the information from the Doxygen XML files. See ${api.cross_document_ref("reference/commands.adoc",
